package com.zww.tnt.any.admin.common.util;
 ...
 * @date 2017/10/29
 */
public class AnyResourcesGenerator {


    public static void main(String[] args) {
        String outputDir = "/Users/zhangwangwang/work";
        ...
        dsc.setUsername("zww");
        dsc.setPassword("1.Session");
        dsc.setUrl("jdbc:mysql://140.143.21.138:3306/pig?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
